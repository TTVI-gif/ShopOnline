...
namespace ShopOnline.AdminApp.Services
{
    public class UserApiClient : IUserApiClient
    {
        ...
        public async Task<ApiResult<string>> Autheticate(LoginRequest request)
        {
            ...
            {
                return JsonConvert.DeserializeObject<ApiSuccessResult<string>>(await repose.Content.ReadAsStringAsync());
            }
